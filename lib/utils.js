...
function isTooDeepOrLarge(obj, maxDepth = 10, maxArrayLength = 1000) {
  function check(o, depth) {
    if (depth > maxDepth) return true
    if (Array.isArray(o) && o.length > maxArrayLength) return true
    if (o && typeof o === 'object') {
      return Object.values(o).some(v => check(v, depth + 1))
    }
    return false
  }
  return check(obj, 0)
