...
class MockInsights {
  ...
  trackEvent(eventTelemetry) {
    ...
    if (this.client) this.client.trackEvent(eventTelemetry)
  }
  ...
  trackMetric(metricTelemetry) {
    ...
    if (this.client) this.client.trackMetric(metricTelemetry)
  }

  trackRequest(requestTelemetry) {
    console.log('Request: ')
    if (this.client) this.client.trackRequest(requestTelemetry)
  }
  ...
  trackDependency(dependencyTelemetry) {
    ...
    if (this.client) this.client.trackDependency(dependencyTelemetry)
  }
}
