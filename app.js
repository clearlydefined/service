...
import createAggregatorService from './business/aggregator.js'
import createDefinitionService from './business/definitionService.js'
import createNoticeService from './business/noticeService.js'
import createStatsService from './business/statsService.js'
import createStatusService from './business/statusService.js'
import createSuggestionService from './business/suggestionService.js'
import createSummaryService from './business/summarizer.js'
import createCondaRepoAccess from './lib/condaRepoAccess.js'
import trySetHeapLoggingAtInterval from './lib/heapLogger.js'
import { setupApiRateLimiterAfterCachingInit, setupBatchApiRateLimiterAfterCachingInit } from './lib/rateLimit.js'
import startCurationProcessing from './providers/curation/process.js'
import startHarvestProcessing from './providers/harvest/process.js'
import loggerFactory from './providers/logging/logger.js'
import setupAttachmentsRoute from './routes/attachments.js'
import setupCurationsRoute from './routes/curations.js'
import setupDefinitionsRoute from './routes/definitions.js'
import setupDefinitionsRouteV1 from './routes/definitions-1.0.0.js'
import setupHarvestRoute from './routes/harvest.js'
import setupIndexRoute from './routes/index.js'
import setupNoticesRoute from './routes/notices.js'
import setupOriginComposer from './routes/originComposer.js'
import setupOriginConda from './routes/originConda.js'
import setupOriginCondaforge from './routes/originCondaforge.js'
import setupOriginCrate from './routes/originCrate.js'
import setupOriginDeb from './routes/originDeb.js'
import setupOriginGitHub from './routes/originGitHub.js'
import setupOriginGitLab from './routes/originGitLab.js'
import setupOriginGo from './routes/originGo.js'
import setupOriginGradlePlugin from './routes/originGradlePlugin.js'
import setupOriginMaven from './routes/originMaven.js'
import setupOriginMavenGoogle from './routes/originMavenGoogle.js'
import setupOriginNpm from './routes/originNpm.js'
import setupOriginNuget from './routes/originNuget.js'
import setupOriginPod from './routes/originPod.js'
import setupOriginPyPi from './routes/originPyPi.js'
import setupOriginRubyGems from './routes/originRubyGems.js'
import setupStatsRoute from './routes/stats.js'
import setupStatusRoute from './routes/status.js'
import setupSuggestionsRoute from './routes/suggestions.js'
